    ...
    setup(props) {
        ...
        const methods = {
            ...
            handleSave() {
                ...
                const dataConfig={
                    formName: data.formOptions.formName,
                    json: JSON.stringify({rule: methods.getJson(), options: methods.getOptionsJson()})
                }

                fetch('http://172.21.30.86:7534/Sys_GetData/SaveConfigFormDynamic',{
                        method: 'POST',
                        headers: {
