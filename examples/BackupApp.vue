<template>
    <div id="app">
        <div class="_fc-top">
            ...
            <div class="_fc-top-nav">
                ...
                <div class="_fc-top-link">
                    ...
                    <a href="https://form-create.com/" target="_blank" class="item">Trang chủ</a>
                    <a href="https://pro.form-create.com/view" class="item pro-version">Phiên bản nâng cao🔥</a>

                    <a href="https://view.form-create.com/" target="_blank" class="item">Tài liệu</a>
                    <a href="https://form-create.com/designer" target="_blank" class="item">Phiên bản Vue2</a>
                    <a href="https://github.com/xaboy/form-create-designer" target="_blank" class="item">Xem mã nguồn</a>
                    ...
                    <el-dropdown>
                        ...
                        <template #dropdown>
                            <el-dropdown-menu>
                                ...
                                <el-dropdown-item @click="setJson">Nhập JSON</el-dropdown-item>
                                <el-dropdown-item @click="setOption">Nhập Options</el-dropdown-item>
                    ...
                    <el-dropdown>
                        ...
                        <template #dropdown>
                            <el-dropdown-menu>
                                ...
                                <el-dropdown-item @click="showJson">Tạo JSON</el-dropdown-item>
                                <el-dropdown-item @click="showOption">Tạo Options</el-dropdown-item>
                                <el-dropdown-item @click="copyUrl">Tạo liên kết xem trước</el-dropdown-item>
        ...
        <el-dialog :title="title[type]" v-model="state" class="_fc-t-dialog">
            ...
            <span style="color: red;" v-if="err">Định dạng nội dung nhập vào không đúng!</span>
            <template #footer v-if="type > 2">
                <span slot="footer" class="dialog-footer">
                    <el-button @click="state = false" size="small">Hủy bỏ</el-button>
                    <el-button type="primary" @click="onOk" size="small">Xác nhận</el-button>
                </span>
            </template>
        </el-dialog>
